...
public class SubscriptionTestServlet extends HttpServlet {
	 ...
	 */
	public SubscriptionTestServlet() {//只有先构造出父亲，才能有子女
		super();
		System.out.println("创建了SubscriptionTestServlet实例:  "+this.hashCode());
	...
	protected void doGet(HttpServletRequest request,
		...
		System.out.println("调用了SubscriptionTestServlet的doGet方法");
...
//		
//		System.out.println("调用了SubscriptionTestServlet的doPost方法");
	}
