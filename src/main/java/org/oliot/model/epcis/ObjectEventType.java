...
public class ObjectEventType extends EPCISEventType {
	...
	public String toString() {
		return "ObjectEventType [epcList=" + epcList + ", action=" + action
				+ ", bizStep=" + bizStep + ", disposition=" + disposition
				+ ", readPoint=" + readPoint + ", bizLocation=" + bizLocation
				+ ", bizTransactionList=" + bizTransactionList + ", ilmd="
				+ ilmd + ", extension=" + extension + ", any=" + any
				+ ", eventTime=" + eventTime + ", recordTime=" + recordTime
