...
public class ObjectEventExtensionType {
	...
	public String toString() {
		return "ObjectEventExtensionType [quantityList=" + quantityList
				+ ", sourceList=" + sourceList + ", destinationList="
				+ destinationList + ", ilmd=" + ilmd + ", extension="
				+ extension + ", otherAttributes=" + otherAttributes + "]";
	}
