...
<head>
    ...
    <meta name="description" content="水产品销售管理" />
...
<body>
			                        ...
			                        <div class="col-xs-12 col-md-12">
			                            <div class="widget widget-table-container">
			                                <div class="widget-header ">
			                                    <span class="widget-caption">水产品销售情况列表</span>
			                                ...
			                                <div class="widget-body" style="min-height: 230px">
			                                	<div class="table-toolbar">
			                                        <div class="buttons-preview" style="border-bottom: 1px solid #e5e5e5;">
			                                            <a id="addButton" href="javascript:void(0);" class="btn btn-default purple" style="margin-right: 10px;"><i class="fa fa-plus"></i>新增销售订单</a>
			                                    ...
			                                    <table class="table table-striped table-bordered table-hover" id="product_datatable" width="100%">
			                                        <thead>
														<tr>
															...
															<th width="15%">交易市场</th>
															<th width="15%">水产品epc编码</th>
															<th width="15%">水产品名称</th>
															<th width="15%">支付方式</th>
															<th width="10%">交易完成时间</th>
														</tr>
													</thead>
			                                        <tbody>
			                                        </tbody>
		...
		<div id="horizontal-form">
           <form class="form-horizontal" role="form" enctype="multipart/form-data">
               ...
               <div class="row">
				    <div class="col-sm-6">
				        <div class="form-group">
						   <label for="name" class="col-sm-2 control-label no-padding-right"><span class="label label-darkpink graded">市场</span></label>
						   <div class="col-sm-10">
							   <input type="text" class="form-control" id="name" name="mrkInfo.name" placeholder="名称" value ="无锡蠡桥水产批发市场" maxlength="50">
						   </div>
					   </div>
				    </div>
				     ...
				     <div class="col-sm-6">
				        <div class="form-group">
						   <label for="name" class="col-sm-2 control-label no-padding-right"><span class="label label-darkpink graded">店员编号</span></label>
						   <div class="col-sm-9 col-md-offset-1">
							   <input type="text" class="form-control" id="no" name="mrkInfo.clerkNum" placeholder="店员编号" value="201701058888" maxlength="50">
						   </div>
					   </div>
				    </div>
				    ...
				    <div class="col-sm-6">
				        <div class="form-group">
						   ...
						   <div class="col-sm-10">
							   <input type="text" class="form-control" id="epc" name="mrkInfo.epc" placeholder="请输入对应产品的epc" value="urn:epc:idpat:sgtin:0614149.112348.12363" maxlength="50">
						   </div>
					   </div>
				    </div>
				</div>
				...
				<div class="row">
				    <div class="col-sm-6">
				        <div class="form-group">
						   <label for="code" class="col-sm-2 control-label no-padding-right"><span class="label label-darkpink graded">交易编号</span></label>
						   <div class="col-sm-9 col-md-offset-1">
							   <input type="text" class="form-control" id="tranno" name="mrkInfo.tranNum" placeholder="交易编号" maxlength="50">
						   </div>
					   </div>
				    </div>
				    ...
				    <div class="col-sm-6">
				        <div class="form-group">
						   <label for="specification" class="col-sm-2 control-label no-padding-right"><span class="label label-darkpink graded">水产品名字</span></label>
						   <div class="col-sm-9 col-md-offset-1">
							   <input type="text" class="form-control" id="aquaticName" name="mrkInfo.aquaticName" placeholder="水产品名字" value="螃蟹 " maxlength="50">
						   </div>
					   </div>
				    </div>
				</div>
				...
				<div class="row">
				     ...
				     <div class="col-sm-6">
				        <div class="form-group">
						   <label for="sourceArea" class="col-sm-2 control-label no-padding-right"><span class="label label-darkpink graded">单价</span></label>
						   <div class="col-sm-10">
							   <input type="text" class="form-control" id="price" name="mrkInfo.price" placeholder="单价" value="10.5" maxlength="50">
						   </div>
					   </div>
				    </div>
				    ...
				    <div class="col-sm-6">
				        <div class="form-group">
						   <label for="sourceArea" class="col-sm-2 control-label no-padding-right"><span class="label label-darkpink graded">重量</span></label>
						   <div class="col-sm-10">
							   <input type="text" class="form-control" id="weight" name="mrkInfo.weight" placeholder="重量" value ="5.5" maxlength="50">
						   </div>
					   </div>
				    </div>
				</div>
				...
				<div class="row">
				    <div class="col-sm-6">
				        <div class="form-group">
						   <label for="price" class="col-sm-2 control-label no-padding-right"><span class="label label-darkpink graded">支付方式</span></label>
						   <div class="col-sm-9 col-md-offset-1">
							   <input type="text" class="form-control" id="payStyle" name="mrkInfo.payStyle" placeholder="支付方式" value="现金" maxlength="50">
						   </div>
					   </div>
				    </div>
				...
				<div class="row">
				    ...
				    <div class="col-sm-6">
				        <div class="form-group">
						   <label for="pirceUnit" class="col-sm-2 control-label no-padding-right"><span class="label label-darkpink graded">完成时间</span></label>
						    <div class="col-sm-9 col-md-offset-1">
		                 <input type="text" class="form-control" id="finishTime" name="mrkInfo.finishTime" placeholder="由后台系统自动生成当前时间" value="" readOnly="true"  maxlength="50">
					   </div>
				    </div>
               ...
               <div class="row">
				...
				<div class="form-group">
                   ...
                   <div class="col-sm-11" id="selectCatalogyBt">
	                   ...
	                   <input type="hidden" id="catalogies" name="mrkInfo.catalog"></input>
                   </div>
               </div>
   ...
   <!--  <script src="assets/js/datatable/datatables-init.js"></script> -->
    ...
    <script src="assets/js/page/saleInfo.js"></script>
