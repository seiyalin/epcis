...
/*     var vResult = false;
    	...
    	function doVerify(){
    		...
    		if(account != ""){
    			//2、校验 
    			$.ajax({
    				url:"${basePath}syfw/user_verifyAccount.action",
...
<form id="form" name="form" action="${basePath }syfw/user_add.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
      ...
      <%--   <tr>
        ...
        <tr>
            <td class="tdBg" width="200px">密码：</td>
             <td><s:textfield id="account" name="user.passWord" /></td>
            
            <%-- <td><s:textfield id="account" name="user.passWord" onchange="doVerify()"/></td> --%>
        </tr>
