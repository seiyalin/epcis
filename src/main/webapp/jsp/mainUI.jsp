...
<div class="container-fluid ">
   <!--导航部分-->
	...
	<div id="navbar">
		<div id="header" class="bg-warning"><h2>欢迎 <a><b></b><font color="red"><s:property value="#session.SYS_USER.userName"/>&nbsp;</font></a> 访问水产品溯源系统</h2>

 
		<div id="linknav">
   		<ul id="nav"class="nav nav-pills bg-primary nav-justified">
   			<li><a href="${pageContext.request.contextPath}/jsp/mainUI.jsp" >主页</a></li>
   			<li><a href="${pageContext.request.contextPath}/jsp/feedUI.jsp">养殖阶段</a></li>
