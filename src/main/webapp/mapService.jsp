...
<script type="text/javascript">
	...
	function trace1() {
		$.get(baseURL+ "/Service/Poll/SimpleEventQuery?MATCH_epc=urn:epc:id:sgtin:4012345.077889.27",
						function(data) {
	...
	function trace2() {
		$.get(baseURL+ "/Service/Poll/SimpleEventQuery?MATCH_outputEPC=urn:epc:id:sgtin:4012345.077889.27",
						function(data) {
							xmlDoc = $.parseXML(data);
							$xml = $(xmlDoc);
							$eventTime = $xml.find("eventTime")[0];
	...
	function trace3() {
		console.log($origin);
		$.get(baseURL + "/Service/Poll/SimpleEventQuery?MATCH_epc="
								+ $origin,
						function(data) {
							xmlDoc = $.parseXML(data);
							$xml = $(xmlDoc);
